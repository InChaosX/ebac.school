...
function Grid3debac3() {
  ...
  return (
    <section
      className=" md:px-20 px-8 py-24 cpr"
      style={{
    ...
    >
      ...
      <div className="overflow-hidden  sm:grid sm:grid-cols-2 py-20 md:-mt-20 -mt-32">
        <img
          alt=""
          src="/zm.png"
          className="h-56 w-full object-contain sm:h-full block sm:hidden "
        />
