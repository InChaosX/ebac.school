...
function Footerebag() {
  return (
    <footer className="mt-32 bg-blue">
		<div className="max-w-lg mx-auto">
			...
			<div className="text-center pb-16 pt-5">
				...
				<div className="px-5 sm:px-0 flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0 justify-center mt-3">
					...
					<button type="submit" className="text-white w-40 sm:w-auto mx-auto sm:mx-0 font-semibold px-5 py-2 rounded-full">Subscribe</button>
				</div>
			</div>
